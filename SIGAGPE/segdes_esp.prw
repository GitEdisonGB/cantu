...
cDesc2   := "Sera impresso de acordo com os parโmetro s solicitados pelo" // 'Serแ impresso de acordo com os parametros solicitados pelo'
cDesc3   := "Utilizador." // 'usuario.'
cString  := 'SRA'
cAlias   := 'SRA'
aOrd     := {"Matrํcula","Centro De Custo"}	// 'Matricula'###'Centro de Custo'
WnRel    := 'SEGDES'
cPerg    := 'SEGDES'                    
cFilAnte := 'ทท'
lEnd     := .F.
lFirst   := .T. 
aReturn  := { "C๓digo de barras",1,"Administra็ใo",2,2,1,'',1 }	// 'Zebrado'###'Administra็ไo'	
aInfo    := {}
nLastKey := 0
nLinha	 := 0
aRegs    := {}
