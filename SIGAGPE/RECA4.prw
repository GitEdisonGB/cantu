...
±±ÃÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄ¿±±
...
±±³M. Silveira ³14/02/17³MRH-6871        ³Geracao de LOG com as matriculas que nao  ³±±
±±³            ³        ³                ³foram enviadas por e-mail					³±±
±±³Oswaldo L.  ³10/03/17³MRH-7270        ³Ajuste de nomes de campos e trativas países³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
User Function reca4(lTerminal,cFilTerminal,cMatTerminal,cMesAnoRef,nRecTipo,cSemanaTerminal)
...
IF !( lTerminal ).And.cPaisLoc<>"PTG" 
	...
	If !Empty(aLog) .And. MsgYesNo(OemToAnsi(STR0208),OemToAnsi(STR0207)) //"Deseja imprimir o LOG das matrículas que não foram enviadas?"#"Atenção"
		fMakeLog(aLog,aTitle,,,"RECIBOLOG",OemToAnsi(STR0209),"G","L",,.F.) //"LOG das matrículas que não foram enviadas"
	EndIf
...
LI ++
@ LI,00  PSAY  "|"
@ LI,46  PSAY "*** "+Alltrim(STR0017)+" ***"	//"RECIBO DE PAGAMENTO  "
@ LI,131 PSAY "|"
...
@ LI,00   PSAY "|" +  STR0213 + "  " + Alltrim(Transform(nSalario,cPict2)) //"| Salario    : "
...
oPrint:Say(0190,0030,Space(20)+"*** "+Alltrim(STR0017)+" ***",oArial08N) //"RECIBO DE PAGAMENTO    
