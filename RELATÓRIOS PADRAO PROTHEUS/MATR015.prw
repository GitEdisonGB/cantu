...
TRCell():New(oSection1,"F8_TIPO"   ,"SF8",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| F015Sel((cAliasSF8)->F8_TIPO == "F", OemToAnsi(STR0020), OemToAnsi(STR0021)) })
...
TRCell():New(oSection4,"F8_TIPO"   ,"SF8",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| F015Sel((cAliasSF8)->F8_TIPO == "F", OemToAnsi(STR0020), OemToAnsi(STR0021)) })
...
/*/
//-----------------------------------------------------------
Static Function F015Sel(lCond, xValA, xValB)
	Local uRet
