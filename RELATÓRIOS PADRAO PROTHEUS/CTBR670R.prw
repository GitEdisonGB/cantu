...
lAllSL  := F670Sel(Empty(mv_par08) .or. mv_par08=="*",.T.,.F.)
lDetail := F670Sel(mv_par12==1,.T.,.F.)
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function CTBR670HCL(lLote)
...
aEval(aStru, { |e|	F670Sel(e[2] <> "C", TcSetField(cTRB,e[1],e[2],e[3],e[4]),Nil) } )

Return

//----------------------------------------------------------
/*/{Protheus.doc}F670Sel
...
/*/
//-----------------------------------------------------------
Static Function F670Sel(lCond, xValA, xValB)
	Local uRet
