...
TRCell():New(oSection1,"NNR_DESCRI","NNR",STR0042,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| F300Sel(mv_par27 ==1 .And. !Empty((cAliasSD3)->NNR_DESCRI), (cAliasSD3)->D3_LOCAL+" - "+(cAliasSD3)->NNR_DESCRI, "")})
...
TRCell():New(oSection2,"QTDENTRADA","   ",STR0043,PesqPictQt("D3_QUANT",17),TamSX3("D3_QUANT")[1],/*lPixel*/,{|| F300Sel((cAliasSD3)->D3_TM <= "500", (cAliasSD3)->D3_QUANT, 0) })
TRCell():New(oSection2,"QTDSAIDA"  ,"   ",STR0044,PesqPictQt("D3_QUANT",17),TamSX3("D3_QUANT")[1],/*lPixel*/,{|| F300Sel((cAliasSD3)->D3_TM > "500", (cAliasSD3)->D3_QUANT, 0) })
TRCell():New(oSection2,"CUSTOUNIT" ,"   ",STR0045,PesqPict("SD3", "D3_CUSTO"+Str(mv_par15,1),17),/*Tamanho*/,/*lPixel*/,{|| (cAliasSD3)->&("D3_CUSTO"+Str(mv_par15,1)) / F300Sel((cAliasSD3)->D3_QUANT == 0, 1, (cAliasSD3)->D3_QUANT) })
TRCell():New(oSection2,"CUSTO"     ,"   ",STR0046,PesqPict("SD3", "D3_CUSTO"+Str(mv_par15,1),17),/*Tamanho*/,/*lPixel*/,{||  F300Sel((cAliasSD3)->D3_TM > "500", ((cAliasSD3)->&("D3_CUSTO"+Str(mv_par15,1)))* -1, (cAliasSD3)->&("D3_CUSTO"+Str(mv_par15,1))) })
...
cCposCtb := F300Sel(nOrdem == 6, "CTT->CTT_CUSTO + '-' + CTT->CTT_DESC" + StrZero(mv_par15, 2), "CT1->CT1_DESC" + StrZero(mv_par15, 2))
...
While !oReport:Cancel() .And. !(cAliasSD3)->(Eof())
   ...
   While !oReport:Cancel() .And. !(cAliasSD3)->(Eof()) .And. cChave == (cAliasSD3)->&(cKeyForTot)
		...
		While !oReport:Cancel() .And. !(cAliasSD3)->(Eof()) .And. cChave == (cAliasSD3)->&(cKeyForTot) .AND. cCodPro == (cAliasSD3)->D3_COD
			...
			nQtd2:= F300Sel(SB1->B1_CONV>0, ConvUm((cAliasSD3)->D3_COD,(cAliasSD3)->D3_QUANT,0,2), (cAliasSD3)->D3_QTSEGUM)
...
/*/
//-----------------------------------------------------------
Static Function F300Sel(lCond, xValA, xValB)
	Local uRet
