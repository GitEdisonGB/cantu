...
oReport := ReportDef()
oReport:PrintDialog(,'SB6') //Informa o Alias principal do relatório como SB6
...
TRCell():New(oSection1,"cCliFor"	,"   "	,/*Titulo*/	,/*Picture*/,F480Sel(TamSx3( "A1_COD" )[ 01 ] >= TamSx3( "A2_COD" )[ 01 ], TamSx3( "A1_COD" )[ 01 ], TamSx3( "A2_COD" )[ 01 ]) ,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"cLoja"		,"   "	," "		,/*Picture*/,F480Sel(TamSx3( "A1_LOJA" )[ 01 ] >= TamSx3( "A2_LOJA" )[ 01 ], TamSx3( "A1_LOJA" )[ 01 ], TamSx3( "A2_LOJA" )[ 01 ]) ,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"cRazaoSocial","   "	,/*Titulo*/	,/*Picture*/,F480Sel(TamSx3( "A1_NOME" )[ 01 ] >= TamSx3( "A2_NOME" )[ 01 ], TamSx3( "A1_NOME" )[ 01 ], TamSx3( "A2_NOME" )[ 01 ])	,/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection2,"B6_TPCF"	 ,"SB6",/*Titulo*/			,/*Picture*/				,TamSx3( "B6_TPCF" )[ 01 ]	,/*lPixel*/,{|| F480Sel((cAliasSB6)->B6_TPCF == "C", STR0018, STR0019) })
...
TRCell():New(oSection2,"cRazaoSocial","   ",/*Titulo*/			,/*Picture*/				,F480Sel(TamSx3( "A1_NOME" )[ 01 ] >= TamSx3( "A2_NOME" )[ 01 ], TamSx3( "A1_NOME" )[ 01 ], TamSx3( "A2_NOME" )[ 01 ])				,/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection2,"B6_QUANT"	 ,"SB6",STR0042+CRLF+STR0043,/*Picture*/				,TamSx3( "B6_QUANT" )[ 01 ]	,/*lPixel*/,{|| F480Sel(mv_par15==1, ConvUM((cAliasSB6)->B6_PRODUTO,(cAliasSB6)->B6_QUANT,0,2), (cAliasSB6)->B6_QUANT) }) //"Quantidade"##"Original"
...
TRCell():New(oSection2,"B6_TIPO"	 ,"SB6",STR0051				,/*Picture*/				,nTamVal-10					,/*lPixel*/,{|| F480Sel((cAliasSB6)->B6_TIPO=="D", "D", "E") }) //"TM"
...
TRCell():New(oSection3,"B6_TPCF"	 ,"SB6",/*Titulo*/			,/*Picture*/				,TamSx3( "B6_TPCF" )[ 01 ]	,/*lPixel*/,{|| F480Sel((cAliasSB6)->B6_TPCF == "C", STR0018, STR0019) })
...
TRCell():New(oSection3,"cRazaoSocial","   ",/*Titulo*/			,/*Picture*/				,F480Sel(TamSx3( "A1_NOME" )[ 01 ] >= TamSx3( "A2_NOME" )[ 01 ], TamSx3( "A1_NOME" )[ 01 ], TamSx3( "A2_NOME" )[ 01 ])				,/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection3,"B6_QUANT"	 ,"SB6",STR0042+CRLF+STR0043,/*Picture*/				,nTamQtd					,/*lPixel*/,{|| F480Sel(mv_par15==1, ConvUM((cAliasSB6)->B6_PRODUTO,(cAliasSB6)->B6_QUANT,0,2), (cAliasSB6)->B6_QUANT) }) //"Quantidade"##"Original"
...
TRCell():New(oSection3,"B6_TIPO"	 ,"SB6",STR0051				,/*Picture*/				,nTamVal-10					,/*lPixel*/,{|| F480Sel((cAliasSB6)->B6_TIPO=="D", "D", "E") }) //"TM"
...
Local lImprime   := .F.
Local lFirstRec  := .T.
Local lPlanilha  := oReport:nDevice == 4 // Impressão Tipo Planilha com tipo de planilha sendo normal, suprime brancos ou tabela
Local lPlanTab   := oReport:lXlsTable == .T. // Impressão Tipo Planilha com tipo de planilha Tabela
Local nX         := 0
Local aStrucSB6  := {}
Local aDadCliFor := {}
Local cQuebra
...
Do Case
	...
	oSection3:Cell("cRazaoSocial"):Hide() // Não imprime, mas deve manter o tamanho
	...
	oSection3:Cell("B6_PRODUTO"):Hide() // Não imprime, mas deve manter o tamanho
...
While !oReport:Cancel() .And. !(cAliasSB6)->(Eof())
	...
	nSaldo  := aSaldo[1]
	nPrUnit := F480Sel(aSaldo[3]==0, (cAliasSB6)->(B6_PRUNIT), aSaldo[3])
	...
	.And. F480Sel(nOrdem==1, cQuebra == (cAliasSB6)->(B6_PRODUTO+B6_LOCAL), F480Sel(nOrdem==2, cQuebra == (cAliasSB6)->(B6_CLIFOR+B6_LOJA+B6_PRODUTO+B6_TPCF), cQuebra == (cAliasSB6)->(Dtos(B6_EMISSAO)+B6_PRODUTO)))
		...
		If lPlanTab
			...
			oSection2:Cell("cRazaoSocial"):SetValue(F480Sel((cAliasSB6)->(B6_TPCF) == "C", SA1->A1_NOME, SA2->A2_NOME))
		...
		If nOrdem == 1
			...
			If !Empty(cProdLocal)
				...
				oSection2:Cell("nQuJe"):SetValue(F480Sel(mv_par15==1, ConvUM((cAliasSB6)->B6_PRODUTO,((cAliasSB6)->B6_QUANT - nSaldo),0,2), ((cAliasSB6)->B6_QUANT - nSaldo)))
				oSection2:Cell("nSaldo"):SetValue(F480Sel(mv_par15==1, ConvUm((cAliasSB6)->B6_PRODUTO,nSaldo,0,2), nSaldo))
...
/*/
//-----------------------------------------------------------
Static Function F480Sel(lCond, xValA, xValB)
	Local uRet
