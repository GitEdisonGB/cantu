...
cSelect+= F980Sel(SerieNfId("SF3",3,"F3_SERIE")<>"F3_SERIE",SerieNfId("SF3",3,"F3_SERIE")+",","")
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_BASERET"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),(cAliasSF3)->F3_BASERET,0)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_BSRET"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),0,(cAliasSF3)->F3_BASERET)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_ICMSRET"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),(cAliasSF3)->F3_ICMSRET,0)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_ICRET"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),0,(cAliasSF3)->F3_ICMSRET)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_BASEICM"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),(cAliasSF3)->F3_BASEICM,0)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_BSICM"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),0,(cAliasSF3)->F3_BASEICM)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_VALICM"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),(cAliasSF3)->F3_VALICM,0)})
oReport:Section(1):Section(1):Section(1):Section(1):Cell("F3_VLICM"):SetBlock({|| F980Sel((cAliasSF3)->F3_TIPO<>"D" .And. ((cAliasSF3)->F3_TIPO<>"B" .And. !((cAliasSF3)->F3_CFO $ "2918#1918")),0,(cAliasSF3)->F3_VALICM)})
			...
			While !Eof().And.cEst+cMun+cCep == A1_EST+A1_MUN+A1_CEP
				...
				While !Eof() .And. cChave==F3Filial("SF3")+F3_CLIEFOR+F3_LOJA
					...
					If mv_par06 == 1
						...
						@ li,101 PSAY F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASERET,0)  Picture PesqPict("SF3","F3_BASERET",14)
						@ li,116 PSAY F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_BASERET)  Picture PesqPict("SF3","F3_BASERET",14)
						@ li,131 PSAY F980Sel(SF3->F3_TIPO<>"D",SF3->F3_ICMSRET,0)  Picture PesqPict("SF3","F3_ICMSRET",14)
						@ li,146 PSAY F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_ICMSRET)  Picture PesqPict("SF3","F3_ICMSRET",14)						
						@ li,161 PSAY F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASEICM,0)  Picture PesqPict("SF3","F3_BASEICM",14)
						@ li,176 PSAY F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_BASEICM0) Picture PesqPict("SF3","F3_BASEICM",14)						
						@ li,191 PSAY F980Sel(SF3->F3_TIPO<>"D",SF3->F3_VALICM,0)   Picture PesqPict("SF3","F3_VALICM",14)
						@ li,206 PSAY F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_VALICM)   Picture PesqPict("SF3","F3_VALICM",14)						
					Endif
					aBaseRet[03]	+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASERET,0)
					aBaseRetD[03]	+= F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_BASERET)
					aValRet[03]		+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_ICMSRET,0)
					aValRetD[03]	+= F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_ICMSRET)
					aBase[03]		+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASEICM,0)
					aBaseD[03]		+= F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_BASEICM)
					aValICM[03]		+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_VALICM,0)
					aValICMD[03]	+= F980Sel(SF3->F3_TIPO<>"D",0,SF3->F3_VALICM)
					aLqBasRet[03]	+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASERET,SF3->F3_BASERET * -1)
					aLqValRet[03]	+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_ICMSRET,SF3->F3_ICMSRET * -1)
					aLqBase[03]		+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_BASEICM,SF3->F3_BASEICM * -1)
					aLqICMS[03]		+= F980Sel(SF3->F3_TIPO<>"D",SF3->F3_VALICM,SF3->F3_VALICM * -1)
					dbSkip()
				EndDo
				dbSelectArea("SA1")
				dbSkip()
...
/*/
//-----------------------------------------------------------
Static Function F980Sel(lCond, xValA, xValB)
	Local uRet
