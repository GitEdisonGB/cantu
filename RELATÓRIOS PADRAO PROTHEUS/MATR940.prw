...
PRIVATE nMes		:=	mv_par01,;
		...
		nQuebra		:=	mv_par06,;
		nIndice		:=	F940Sel(mv_par07>0,mv_par07,1),;
		...
		lMv_UFSt  	:=  F940Sel(!Empty(GetNewPar("MV_UFST","")),.T.,.F.),;
		lCrdEst		:=	(MV_PAR21==1),;
		cFilDe		:=	F940Sel (Empty (MV_PAR22) .And. Empty (MV_PAR23), cFilAnt, MV_PAR22),;
		cFilAte		:=	F940Sel (Empty (MV_PAR23), cFilAnt, MV_PAR23)
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
