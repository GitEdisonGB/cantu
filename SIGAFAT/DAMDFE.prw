	...
	If oWS:RETORNANOTASNX()
		If Len(oWs:oWSRETORNANOTASNXRESULT:OWSNOTAS:OWSNFES5) > 0
			For nX := 1 To Len(oWs:oWSRETORNANOTASNXRESULT:OWSNOTAS:OWSNFES5)
				...
				cModTrans		:= IIf(XMLChildEx(oNFeRet:_MDFe:_infMDFe:_ide:TEXT, "_tpEmis") <> "U",IIf (!Empty("oNFeRet:_MDFe:_infMDFe:_ide:_tpEmis:TEXT"),oNFeRet:_MDFe:_infMDFe:_ide:_tpEmis:TEXT,1),1)
				...
				If !Empty(cProtocolo)
					...
					cDtHrRec  := IIf(XMLChildEx(oDHRecbto:_ProtMDfe:_INFPROT:TEXT, "_DHRECBTO")<>"U",oDHRecbto:_ProtMDfe:_INFPROT:_DHRECBTO:TEXT,"")
					...
					EndIf
				Else
					cDtHrRec  := IIf(XMLChildEx(oNFeRet:_MDFe:_infMDFe:_ide:TEXT, "_dhEmi")<>"U",oNFeRet:_MDFe:_infMDFe:_ide:_dhEmi:TEXT,"")
					nDtHrRec1 := RAT("T",cDtHrRec)
