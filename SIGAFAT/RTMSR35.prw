...
While !(cAliasCT)->(Eof())
	...
	//-- Complemento	FisGetEnd(XXXXXXXX)[4]
		...
		//-- Origem da Prestacao
		cOriMunPre	:= Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:TEXT, "_XMUNINI")=="U"," ",oNfe:_CTE:_INFCTE:_IDE:_XMUNINI:TEXT)
		...
		//-- Remetente
		If XMLChildEx(oNfe:_CTE:_INFCTE, "_REM") <> "U"
			...
			cRemCompl := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_ENDERREME:TEXT, "_XCPL")=="U"," ",oNfe:_CTE:_INFCTE:_REM:_ENDERREME:_XCPL:TEXT)
			cRemBair  := oNfe:_CTE:_INFCTE:_REM:_ENDERREME:_XBAIRRO:TEXT
			cRemCEP   := oNfe:_CTE:_INFCTE:_REM:_ENDERREME:_CEP:TEXT
			cRemCNPJ  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:TEXT, "_CNPJ")=="U",oNfe:_CTE:_INFCTE:_REM:_CPF:TEXT,oNfe:_CTE:_INFCTE:_REM:_CNPJ:TEXT)
			cRemIE    := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:TEXT, "_IE")=="U"," ",oNfe:_CTE:_INFCTE:_REM:_IE:TEXT)
			cRemPais  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_ENDERREME:TEXT, "_XPAIS")=="U"," ",oNfe:_CTE:_INFCTE:_REM:_ENDERREME:_XPAIS:TEXT)
			cRemFone  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:TEXT, "_FONE")=="U"," ",oNfe:_CTE:_INFCTE:_REM:_FONE:TEXT)
		EndIf
		//-- Expedidor
		If (XMLChildEx(oNfe:_CTE:_INFCTE, "_EXPED")) <> "U"
			lExped		:= .T.
			...
			cExpCNPJ  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_EXPED:TEXT, "_CNPJ")=="U", oNfe:_CTE:_INFCTE:_EXPED:_CPF:TEXT , oNfe:_CTE:_INFCTE:_EXPED:_CNPJ:TEXT)
			cExpIE    := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_EXPED:TEXT, "_IE")=="U"," ",oNfe:_CTE:_INFCTE:_EXPED:_IE:TEXT)
			cExpPais  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_EXPED:_ENDEREXPED:TEXT, "_XPAIS")=="U"," ",oNfe:_CTE:_INFCTE:_EXPED:_ENDEREXPED:_XPAIS:TEXT)
			cExpFone  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_EXPED:TEXT, "_FONE")=="U"," ",oNfe:_CTE:_INFCTE:_EXPED:_FONE:TEXT)
		EndIf

		//-- Destinatario
		If XMLChildEx(oNfe:_CTE:_INFCTE, "_DEST") <> "U"
			...
			cDesCompl := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:TEXT, "_XCPL")=="U"," ", oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:_XCPL:TEXT)
			cDesBair  := oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:_XBAIRRO:TEXT
			cDesCEP   := oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:_CEP:TEXT
			cDesCNPJ  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_DEST:TEXT, "_CNPJ")=="U",    oNfe:_CTE:_INFCTE:_DEST:_CPF:TEXT, oNfe:_CTE:_INFCTE:_DEST:_CNPJ:TEXT)
			cDesIE    := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_DEST:TEXT, "_IE")=="U"," ",oNfe:_CTE:_INFCTE:_DEST:_IE:TEXT)
			cDesPais  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:TEXT, "_XPAIS")=="U"," ",oNfe:_CTE:_INFCTE:_DEST:_ENDERDEST:_XPAIS:TEXT)
			cDesFone  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_DEST:TEXT, "_FONE")=="U"," ",oNfe:_CTE:_INFCTE:_DEST:_FONE:TEXT)
		EndIf

		//-- Local de Entrega
		If (XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB, "_ENDERRECEB")) <> "U"
			lSeqRec := .T.
			//Destino Recebedor
			...
			cRecPais  	:= Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:TEXT, "_XPAIS")=="U"," ",oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:_XPAIS:TEXT)
			cRecCompl 	:= Iif( XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:TEXT, "_XCPL") == "U"," ",oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:_XCPL:TEXT )
			cRecCEP   	:= Iif( XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:TEXT, "_CEP")  == "U"," ",oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:_CEP:TEXT  )

			cRecFone := Iif( XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:TEXT, "_FONE") == "U"," ",oNfe:_CTE:_INFCTE:_RECEB:_FONE:TEXT )
			If Empty(cRecFone)
				cRecFone := Iif( XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:TEXT, "_FONE") == "U"," ",oNfe:_CTE:_INFCTE:_RECEB:_ENDERRECEB:_FONE:TEXT )
			EndIf

			If XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:TEXT, "_CNPJ")=="U"
				cRecCPF	:= oNfe:_CTE:_INFCTE:_RECEB:_CPF:TEXT
			Else
				cRecCGC	:= oNfe:_CTE:_INFCTE:_RECEB:_CNPJ:TEXT
				cRecINSCR := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_RECEB:TEXT, "_IE" )=="U"," ",oNfe:_CTE:_INFCTE:_RECEB:_IE:TEXT)
				lRecPJ	:= .T.
			EndIf
		EndIf

		//-- Produto Predominante
		If (XMLChildEx(oNFE:_CTE:_INFCTE, "_INFCTENORM")) <> "U"
			If XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFCARGA, "_PROPRED") <>  "U"
				cPPDesc		:= oNFE:_CTE:_INFCTE:_INFCTENORM:_INFCARGA:_PROPRED:TEXT
			EndIf
			If XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFCARGA, "_XOUTCAT") <>  "U"
				cPPCarga	:= oNFE:_CTE:_INFCTE:_INFCTENORM:_INFCARGA:_XOUTCAT:TEXT
			EndIf
			If XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFCARGA, "_VMERC") <> "U"
		...
		If XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:_TOMA3:TEXT, "_TOMA") <> "U"
			...
			ElseIf oNfe:_CTE:_INFCTE:_IDE:_TOMA3:_TOMA:TEXT == "3"
				...
				cDevFone  := cDesFone
			EndIf
		ElseIf XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:_TOMA4:TEXT, "_TOMA") <> "U"
			If oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_TOMA:TEXT == "4"
				...
				cDevCNPJ  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:_TOMA4:TEXT, "_CNPJ")=="U",oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_CPF:TEXT,oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_CNPJ:TEXT)
				cDevIE    := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:_TOMA4:TEXT, "_IE"  )=="U"," ",oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_IE:TEXT)
				cDevPais  := ""
				cDevFone  := Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_IDE:_TOMA4:TEXT, "_FONE")=="U"," ",oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_FONE:TEXT)
			EndIf
		EndIf
		//-- Documentos Originarios
		aDocOri := {}
		If	( XMLChildEx(oNFE:_CTE:_INFCTE:_REM, "_INFNFE" ) <> 'U' )
			...
			ElseIf ValType( oNFE:_CTE:_INFCTE:_REM:_INFNFE ) == 'O'
				...
				EndIf
			EndIf
		ElseIf	( XMLChildEx(oNFE:_CTE:_INFCTE:_REM, "_INFNF") <> 'U' )
			If ValType( oNFE:_CTE:_INFCTE:_REM:_INFNF ) == 'A'
				...
				Next nCount
				//-- Local de Retirada
				If (XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_INFNF[1], "_LOCRET")) <> "U"
					...
					cExpCEP   	:= ""
					cExpCNPJ  	:= Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_INFNF[1]:_LOCRET:TEXT, "_CNPJ")=="U", oNfe:_CTE:_INFCTE:_REM:_INFNF[1]:_LOCRET:_CPF:TEXT , oNfe:_CTE:_INFCTE:_REM:_INFNF[1]:_LOCRET:_CNPJ:TEXT)
					cExpIE    	:= ""
					cExpPais  	:= cRemPais
					cExpFone  	:= ""
				EndIf
			Else
				If aScan(aDocOri,{|x|x[1]+x[2]==oNFE:_CTE:_INFCTE:_REM:_INFNF:_SERIE:TEXT+oNFE:_CTE:_INFCTE:_REM:_INFNF:_NDOC:TEXT})==0
					...
					'' })
				EndIf
				If (XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_INFNF, "_LOCRET")) <> "U"
					...
					cExpCEP   	:= ""
					cExpCNPJ  	:= Iif(XMLChildEx(oNfe:_CTE:_INFCTE:_REM:_INFNF:_LOCRET:TEXT, "_CNPJ")=="U", oNfe:_CTE:_INFCTE:_REM:_INFNF:_LOCRET:_CPF:TEXT , oNfe:_CTE:_INFCTE:_REM:_INFNF:_LOCRET:_CNPJ:TEXT)
					cExpIE    	:= ""
					cExpPais  	:= cRemPais
					cExpFone  	:= ""
			EndIf
			EndIf
        //Aqui Inicio
		ElseIf  (XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFDOC, "_INFNF")) <> 'U'
	        ...
	        // Fim
		ElseIf	( XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFDOC, "_INFNFE" ) <> 'U' )
			...
			ElseIf ValType( oNFE:_CTE:_INFCTE:_INFCTENORM:_INFDOC:_INFNFE ) == 'O'
				...
				EndIf
			EndIf
		ElseIf	( XMLChlidEx(oNFE:_CTE:_INFCTE:_REM, "_INFOUTROS" ) <> 'U' )
			...
			Else
				...
				EndIf
			EndIf
		ElseIf	( XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFDOC, "_INFOUTROS" ) <> 'U' )
		...
		If	( XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_DOCANT:_EMIDOCANT:_IDDOCANT, "_IDDOCANTELE" ) <> 'U' )
	...
	dbSelectArea("DT6") //-- Nao retirar
		cDT6Obs := " "
		If XMLChildEx(oNfe:_CTE:_INFCTE:_IMP:TEXT, "_INFADFISCO") == "U"
			cDT6Obs := " "
		Else
			cDT6Obs := oNfe:_CTE:_INFCTE:_IMP:_INFADFISCO:TEXT
		EndIf
		cObsProp := " "
		If XMLChildEx(oNfe:_CTE:_INFCTE:_INFCTENORM:_INFMODAL:_RODO:_VEIC:_PROP:TEXT, "_XNOME") != "U" .And.;
			XMLChildEx(oNfe:_CTE:_INFCTE:_INFCTENORM:_INFMODAL:_RODO:_VEIC:TEXT, "_TPPROP") != "U"
		...
		EndIf
		cDTCObs := " "
		If XMLChildEx(oNfe:_CTE:_INFCTE:_COMPL:TEXT, "_XOBS") != "U"
			cDTCObs += oNfe:_CTE:_INFCTE:_COMPL:_XOBS:TEXT
		EndIf
		If XMLChildEx(oNfe:_CTE:_INFCTE:_COMPL, "_OBSCONT") == "A"
			aObsCont := {}
			For nX := 1 to len(oNfe:_CTE:_INFCTE:_COMPL:_OBSCONT)
				aAdd(aObsCont, oNfe:_CTE:_INFCTE:_COMPL:_OBSCONT[nX]:_XTEXTO:TEXT )
			Next nX
		ElseIf XMLChildEx(oNfe:_CTE:_INFCTE:_COMPL:_OBSCONT:TEXT, "_XTEXTO") == "U"
			aObsCont := {""}
		Else
	...
	If  oNfe:_CTE:_INFCTE:_IDE:_modal:TEXT == "06" // do tipo MultiModal
		...
		oDacte:Line(0654+nLinIEM, 0000, 0652, 0559)
		oDacte:Say(0661+nLinIEM, 0003, "COTM da Empresa: " + cTmsCOTM	, oFont08)

		If (XMLChildEx(oNFE:_CTE:_INFCTE:_INFCTENORM:_INFMODAL, "_MULTIMODAL")) <> "U" //Existe Stru da MultiModal.
			...
			If (cIndNegoci == "1")
				oDacte:Say(0664, 0287, "X" /* DTC_INDNEG */	, oFont08)
			Else
				oDacte:Say(0664, 0352, "X" /* DTC_INDNEG */	, oFont08)
			EndIf
		EndIf
	Else
		oDacte:Box(0645+nLinIEM, 0000, 0672+nLinIEM, 0559)
		oDacte:Say(0651+nLinIEM, 0210, "Informações do Modal Rodoviário", oFont08N)
		oDacte:Line(0654+nLinIEM, 0000, 0652+nLinIEM, 0559)
...
If Type("oNfe:_CTE:_INFCTE:_EMIT") <> "U"
	...
	oDacte:Say(0110, 0090, 'CNPJ ' + Transform(AllTrim(oNfe:_CTE:_INFCTE:_EMIT:_CNPJ:TEXT),"@r 99.999.999/9999-99") +;
						   ' - IE ' + Iif(Type("oNfe:_CTE:_INFCTE:_EMIT:_IE:TEXT"  )=="U"," ",AllTrim(oNfe:_CTE:_INFCTE:_EMIT:_IE:TEXT)), oFont07)
	oDacte:Say(0120, 0090, AllTrim(oNfe:_CTE:_INFCTE:_EMIT:_ENDEREMIT:_XLGR:TEXT) + ;
						   ...
						   Iif(Type("oNfe:_CTE:_INFCTE:_EMIT:_ENDEREMIT:_XCPL")=="U", " ", " " + AllTrim(oNfe:_CTE:_INFCTE:_EMIT:_ENDEREMIT:_XCPL:TEXT) + " ") +;
	...
	oDacte:Say(0140, 0090, AllTrim(Iif(Type("oNfe:_CTE:_INFCTE:_EMIT:_ENDEREMIT:_FONE:TEXT")=="U"," ",oNfe:_CTE:_INFCTE:_EMIT:_ENDEREMIT:_FONE:TEXT))	,oFont07)	//Telefone
Else
...
If Type( 'oNfe:_CTE:_INFCTESUPL') != 'U'
...
oDacte:Say(0144, 0397, Iif(Type("oNfe:_CTE:_INFCTE:_DEST:_ISUF:TEXT")=="U"," ",oNfe:_CTE:_INFCTE:_DEST:_ISUF:TEXT), oFont07)
