	...
	#define STR0044 "La Tarea se reajusto en el archivo de Parametros 59. NO existen Asientos para esta Tarea"
	...
	#define STR0047 " excedio la capacidad maxima de almacenamiento del campo RO_VALOR"
		...
		#define STR0044 "Task was adjusted in Parameters 59 file. However, there are entries for this task."
		...
		#define STR0044 If( cPaisLoc $ "ANG|PTG", "A Actvidade foi reajustada no cadastro de Parâmetros 59. Mas não existem Lançamentos para esta Actividade", "A Tarefa foi reajustada no cadastro de Parâmetros 59. Mas não existem Lançamentos para esta Tarefa" )
