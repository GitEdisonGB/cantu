	...
	#define STR0043 "HE. "
		...
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "FI C.CUSTO  SEGMENTO    REG.  NOME                                  CÓD.DESCRIÇÃO           HORAS         V A L O R", "FI C.CUSTO  SEGMENTO    MATR.  NOME                                 COD DESCRICAO           HORAS         V A L O R" )
