	...
	#define STR0037 "Sec."
		...
		#define STR0021  "PRODUTO         DESCRICAO                             QTD UM      PESO SEP/CARR/CX" // ADRIANO
		#define STR0022  "PRODUTO                          DESCRICAO                      LOTE       SUBLOTE  QTD. 1aUM   UNID.     " // ADRIANO
	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			...
			STR0013 := "Data    :"
			STR0014 := " as "
			STR0015 := "ITEM ARTIGO                         DESCRIÇÃO                           QTD 1aUM  UNID.      QTD 2aUM   SEG.UN.MED.        VALOR           PESO        VOLUME"
			STR0016 := "A Seleccionar Registos..."
			STR0017 := "Factura : "
			STR0018 := " nro : "
			STR0021 := "ARTIGO                          DESCRIÇÃO                      QTD. 1aUM     UNID.     QTD. 2aUM 2aUM                  PESO         VOLUME             VALOR"
			STR0022 := "ARTIGO                          DESCRIÇÃO                      LOTE       SUBLOTE  QTD. 1aUM     UNID.     QTD. 2aUM 2aUM                  PESO         VOLUME             VALOR"
			STR0023 := "ITEM ARTIGO                         DESCRIÇÃO                       LOTE       SUBLOTE     QTD. 1aUM  UNIDADE   QTD. 2aUM   SEG.UN.MED.        VALOR           PESO        VOLUME"
			STR0024 := "Total Crial"
			STR0027 := "Pedido/item"
