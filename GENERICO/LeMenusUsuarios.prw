...
@ 10, 05 Say "Informe o código do módulo:"
@ 10, 90 Get nMenu Picture "@E 99"
@ 40,100 BMPBUTTON TYPE 1 ACTION Close(oDlg1)
ACTIVATE DIALOG oDlg1 CENTERED

if (nMenu > 0)
	MsgRun( "Obtendo infomrações do menu dos usuarios no arquivo SIGAPSS.SPF",	"Aguarde...", {|| U_Spf_Proc(nMenu) } )
EndIf
...
Aviso("Menus dos usuários", cMenus, {"OK"}, 3)
...
Next nx*/                                          // Valida se o usuário está bloqueado
