...
±±∫Desc.     ≥RelatÛrio contendo informaÁıes de titulos desconto a ser    ∫±±
±±∫          ≥cobrado em lanÁamentos de NCC                               ∫±±
...
User Function RDESCCOB()
	...
	Private cTitle		:= "Desconto a cobrar lanÁamento de NCC"
	Private cHelp		:= "Este relatÛrio ter por objetivo detalhar os desconto a ser cobrado no lanÁamento de NCC."
...
Static Function REL01()
	...
	TRCell():New(oSection1, "E1_VALOR"            , "SE1", "Vlr TÌtulo lanÁado"  ,/*cPicture*/,15,/*lPixel*/,/*bBlock*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,.T.)
