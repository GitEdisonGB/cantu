...
ฑฑบPrograma  ณRELPAGAG บAutor ณEdison Greski Barbieri บ Data ณ 03/04/2019 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRelat๓rio contendo informa็๕es de titulos agendados         บฑฑ
ฑฑบ          ณou nao agendados para pagamento.                          บฑฑ
...
User Function RELPAGAG()
Private oReport
Private cFile		:= "RELPAGAG"
Private cPerg		:= "RELPAGAG01"
Private cTitle		:= "Pagamentos Agendados"
Private cHelp		:= "Este relat๓rio ter por objetivo detalhar pagamento agendados fornecedores."
...
TRCell():New(oSection1, "E2_X_DCRUR"	, "SE2", "Nota Produtor"      ,/*cPicture*/,9,/*lPixel*/,/*bBlock*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,.T.)
TRCell():New(oSection1, "E2_VENCTO"	    , "SE2", "Vencimento"         ,/*cPicture*/,8,/*lPixel*/,/*bBlock*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,.T.)
...
BEGIN REPORT QUERY oSection1
	...
	BEGINSQL Alias cAliasTMP
	 ...
	 SELECT 
           ...
           GROUP BY PT2.PT2_NOME, E2.E2_FILIAL, E2.E2_FORNECE, E2.E2_LOJA, E2.E2_NOMFOR, E2.E2_EMISSAO, E2.E2_NUM, E2.E2_PARCELA, E2.E2_X_DCRUR, E2.E2_VENCTO, E2.E2_VALOR, E2_X_AVCTO, E2.E2_DECRESC
           HAVING CASE WHEN E2.E2_X_AVCTO <> ' '  THEN '1'
           			   WHEN E2.E2_X_AVCTO = ' '  THEN '2'
                       END = %Exp:MV_PAR12%
            
		   ORDER BY PT2.PT2_NOME, E2.E2_FORNECE, E2.E2_LOJA, E2.E2_EMISSAO, E2.E2_NUM, E2.E2_PARCELA, E2.E2_VENCTO, E2.E2_VALOR
    ENDSQL
