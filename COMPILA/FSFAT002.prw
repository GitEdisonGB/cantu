...
//| TABELA
#DEFINE D_ALIAS 'ZFC'
#DEFINE D_TITULO 'Cliente com exceção Bancária'
#DEFINE D_ROTINA 'FSFAT002'
#DEFINE D_MODEL 'ZFCMODEL'
#DEFINE D_MODELMASTER 'ZFCMASTER'
#DEFINE D_VIEWMASTER 'VIEW_ZFC'
...
oModel:AddFields( D_MODELMASTER, /*cOwner*/, oStruct,/*{ |oModel| U_FSFATOK('LPRE_ZFC', oModel ) }*/, /*bPosValidacao*/, /*bCarga*/ ) 
